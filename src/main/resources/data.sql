...
INSERT INTO discounts (product_id, description, discount_type, rules, expiration_date) VALUES (1, '10% Off', 'PERCENTAGE', '{"percentage":10}', '2025-12-31T23:59:59');
...
INSERT INTO orders (user_id, status, total_price, created_at) VALUES (1, 'SHIPPED', 129.99, CURRENT_TIMESTAMP);

-- Order Items (for the last inserted order and product)
INSERT INTO order_items (order_id, product_id, quantity, price_at_purchase) VALUES (1, 1, 1, 129.99);
